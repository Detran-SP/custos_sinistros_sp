...
Os dados foram filtrados pelas datas e separados pelo tipo de via. Neste processo, todos as entradas no atributo `tipo_via` que estavam como "RODOVIAS", "RURAL" e "RURAL (COM CARACTERÍSTICA DE URBANA)" foram classificadas como **Estradas e rodovias**. As vias classificadas como "URBANA" e "VIAS MUNICIPAIS" foram classificadas como **Vias urbanas**. Ainda, a base do infosiga possui alguns registros em que não há o tipo de via registrado.
