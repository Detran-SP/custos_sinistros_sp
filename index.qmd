...
As @fig-veiculos-rodovias e @fig-veiculos-urbanos apresentam a quantidade de veículos envolvidos em sinistros, segundo o tipo de via, o tipo de veículo envolvido e a gravidade do evento. Em vias urbanas, os veículos mais frequentemente associados a sinistros não fatais são os automóveis (76.442 casos) e motocicletas (69.413 casos). Já entre os sinistros fatais, as motocicletas aparecem com destaque (1.657 casos), seguidas pelos automóveis (1.435 casos).
