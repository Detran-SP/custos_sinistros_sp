...
A @tbl-vitimas apresenta a quantidade de vítimas envolvidas nos sinistros, segundo o tipo de via, a gravidade e o tipo de sinistro. Nas vias urbanas, observa-se que a maioria dos sinistros não fatais está associada a vítimas com gravidade leve (97.741 casos) ou gravidade não disponível (108.370 casos). Os sinistros fatais totalizam 3.246, todos classificados como de gravidade fatal.

Nas rodovias, a distribuição é semelhante. O maior volume de sinistros não fatais envolve vítimas com gravidade leve (22.760 casos) ou gravidade não disponível (18.247 casos). Já os sinistros fatais totalizam 2.539 com gravidade fatal, além de 1.154 registros com gravidade não disponível.
...
As @fig-veiculos-rodovias e @fig-veiculos-urbanos apresentam a quantidade de veículos envolvidos em sinistros, segundo o tipo de via, o tipo de veículo envolvido e a gravidade do evento. Em vias urbanas, os veículos mais frequentemente associados a sinistros não fatais são os automóveis (51.560 casos) e motocicletas (44.563 casos). Já entre os sinistros fatais, as motocicletas aparecem com destaque (1.221 casos), seguidas pelos automóveis (1.064 casos).

Nas rodovias, o padrão é semelhante. Os sinistros não fatais incluem majoritariamente automóveis (14.350 casos) e motocicletas (10.013 casos). Entre os sinistros fatais, os automóveis lideram com 1.317 registros, seguidos por motocicletas (613) e caminhões (464). Em ambos os tipos de via, observa-se que as motocicletas concentram uma proporção expressiva dos sinistros fatais.
...
Conforme mostrado na @fig-custos, os custos com sinistros em vias urbanas atingem quase R$ 7,7 bilhões, concentrando a maior parte das perdas. Já nas rodovias, os danos relacionados aos veículos representaram quase R$ 1 bilhão, seguidos pelos custos relacionados as vítimas (R$ 4 bilhões) e por infraestrutura e patrimônio (R$ 18 milhões). Houve ainda R$ 240 milhões registrados em locais não identificados.
...
A @tbl-resultados-pessoas detalha os custos relacionados às vítimas de sinistros ocorridos em rodovias. Apesar de representarem apenas 2.539 casos, os óbitos resultaram em um impacto financeiro expressivo, atingindo quase R$ 2 bi. O custo associados às vítimas em estado grave também contribuíram significativamente para o total, com quase R$ 1 bi, mesmo sendo em menor número que os feridos leves. Estes últimos, embora mais numerosos (22.760), representaram um custo relativamente menor, de aproximadamente R$ 350 milhões. No caso das vítimas com gravidade não disponível, houveram 19.401 casos, com custo aproximado de R$ 720 milhões. Ao todo, os custos com pessoas somaram aproxcimadamente R$ 4 bilhões no período analisado.
...
Na @tbl-resultados-veiculos, observam-se os custos associados aos veículos envolvidos em sinistros em rodovias. Automóveis e caminhões concentram a maior parte do impacto financeiro. Em especial, os caminhões envolvidos em sinistros não fatais geraram um custo de R$ 360 milhões, reflexo do elevado valor médio por unidade. Já entre os casos fatais, destacam-se os custos com automóveis (quase R$ 46 milhões) e caminhões (R$ 40 milhões). O custo agregado para esse componente chegou a R$ 940 milhões.
...
Somando os diferentes componentes analisados — custos com pessoas, veículos e danos institucionais — os sinistros em rodovias resultaram em um impacto econômico superior a R$ 4 bilhões apenas com vítimas, R$ 1 bilhão em danos aos veículos envolvidos e quase R$ 18 milhões relacionados a encargos institucionais e prejuízos patrimoniais. Esses valores ilustram a abrangência das perdas provocadas pelos sinistros, que vão muito além das vítimas, envolvendo também danos materiais e custos indiretos para o poder público.
...
Considerando os três tipos de via analisados, os sinistros em vias urbanas concentram o maior volume de custos, totalizando cerca de R$ 7,76 bilhões, impulsionados principalmente pelos sinistros não fatais. Nas rodovias, o impacto foi de aproximadamente R$ 5 bilhões, distribuídos entre custos com vítimas, veículos e danos institucionais. Já os registros em locais não identificados, apesar de menos numerosos, somaram R$ 240 milhões exclusivamente em sinistros fatais. Esses números evidenciam tanto a magnitude dos prejuízos econômicos quanto a necessidade de qualificar os dados geográficos para aprimorar a gestão da segurança viária.
