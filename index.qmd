...
É importante ressaltar a expressiva quantidade de registros com gravidade não disponível, tanto nas rodovias quanto nas vias urbanas. Essa ausência de informação compromete a análise mais precisa dos impactos dos sinistros.
...
A @fig-veiculos apresenta a quantidade de veículos envolvidos em sinistros, segundo o tipo de via, o tipo de veículo envolvido e a gravidade do evento. Em vias urbanas, os veículos mais frequentemente associados a sinistros não fatais são os automóveis (76.446 casos) e motocicletas (69.418 casos), seguidos por bicicletas (4.163). Já entre os sinistros fatais, as motocicletas aparecem com destaque (1.653 ocorrências), seguidas pelos automóveis (1.357 casos) e caminhões (264 casos).
...
Conforme mostrado na @fig-custos, os custos com sinistros em vias urbanas superaram R$ 7,7 bilhões em abril de 2025, concentrando a maior parte das perdas. Já nas rodovias, os danos relacionados aos veículos representaram R$ 1,7 bilhão, seguidos pelos custos relacionados as vítimas (quase R$ 3,3 bilhões) e por infraestrutura e patrimônio (R$ 18 milhões). Houve ainda R$ 241 milhões registrados em locais não identificados.
